...
module.exports = {
    ...
    minArgs: 2,
    maxArgs: 2,
    expectedArgs: "<target user's @> <Amounth of coins>",
    callback: async (message, arguments, text) => {
        ...
        message.reply(`You have giving <@${target.id}> ${coinsToGive} coins! They now have ${newBalance} coins and you have ${remainingCoins} coins.`)
    }
}